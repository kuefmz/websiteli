...
export const realPortfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    projectFeatures: [
      "Public-web identity research flow",
      "Explicit identity selection before reporting",
      "Transparent source-oriented findings",
      "Privacy-conscious result handling",
    ],
    businessOutcomes: [
      "Users get a clearer workflow for reviewing public information before making trust decisions.",
      "The interface separates candidate selection from the final findings experience.",
      "The product demonstrates a focused search application rather than a generic marketing site.",
    ],
    featured: true,
    verifiedUrl: true,
  },
  {
    ...
    projectFeatures: [
      "Multilingual discovery experience",
      "Structured shop and product listings",
      "Map-based browsing",
      "Comparison-oriented information architecture",
    ],
    businessOutcomes: [
      "Visitors can discover shops and products through a more structured browsing experience.",
      "Country and language expansion can reuse the same data-driven interface.",
      "The platform demonstrates marketplace, map and comparison capabilities in one product.",
    ],
    featured: true,
    verifiedUrl: true,
  },
