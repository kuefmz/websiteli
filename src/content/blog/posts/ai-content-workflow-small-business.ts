...
export default {
  ...
  imageAlt: "Diagram-style illustration of an AI-assisted content workflow moving from approved business sources through drafting, human review and website publishing.",
  author: "Websiteli",
  date: "2026-07-30",
