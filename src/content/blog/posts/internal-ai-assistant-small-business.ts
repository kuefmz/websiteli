...
export default {
  ...
  published: true,
  status: "published",
  image: "/assets/blog/internal-ai-assistant-small-business.png",
  imageAlt: "Websiteli social title card reading Internal AI Assistant for Small Businesses with use cases, costs, risks, privacy, controlled sources and ownership cues.",
  author: "Websiteli",
  date: "2026-08-02",
