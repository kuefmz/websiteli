...
export default {
  ...
  published: true,
  status: "published",
  image: "/assets/blog/internal-ai-assistant-small-business.webp",
  imageAlt: "Internal AI assistant workspace showing approved knowledge, use cases, costs, risks, privacy controls and ownership cues.",
  author: "Websiteli",
  date: "2026-08-02",
