...
export default {
  ...
  published: true,
  status: "published",
  image: "/assets/blog/ai-chatbot-vs-internal-ai-assistant.webp",
  imageAlt: "Split comparison showing a customer-facing AI chatbot on a phone and an internal AI assistant connected to private documents and access controls.",
  author: "Websiteli",
  date: "2026-07-31",
